...
namespace knowledge_hub.WebAPI.Migrations
{
    ...
    [Migration("20220912183025_RefactoringOfOrders")]
    partial class RefactoringOfOrders
    {
            ...
            modelBuilder.Entity("knowledge_hub.WebAPI.Database.Login", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "1dK2A6kV0VGbJFtkHVqzNIyXHDc=",
                            PasswordSalt = "w/A4UXsmkM6HQ746fGlAfg=="
                        },
                        new
                        {
                            LoginId = 2,
                            Email = "delivery@knowledge.com",
                            PasswordHash = "rtBHKbWlDBopnAp/u9AoQ9p2NUc=",
                            PasswordSalt = "qaHss2DPh9UeKXkwVcNr9g=="
                        },
                        new
                        {
                            LoginId = 3,
                            Email = "user1@knowledge.com",
                            PasswordHash = "l03whAZbuL7JNXyjYD9dxiXtOPk=",
                            PasswordSalt = "tyF1Vd6ssjKnLmhZVuPfNg=="
                        },
                        new
                        {
                            LoginId = 4,
                            Email = "user2@knowledge.com",
                            PasswordHash = "mfVE+ifAvVFlDdEi++2yQNwB5AY=",
                            PasswordSalt = "9jhwf1dUyHJEYZa51JqZ3Q=="
                        });
                });
            ...
            modelBuilder.Entity("knowledge_hub.WebAPI.Database.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookId = 1,
                            Digital = true,
                            OrderDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7178),
                            OrderNumber = "8e778038-71fc-4930-bbee-197c50499f9d",
                            OrderStatus = 0,
                            ShippingDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7209),
                            UserFullName = "User 1",
                            UserId = 3
                        },
                        new
                        {
                            ...
                            BookId = 2,
                            Digital = true,
                            OrderDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7211),
                            OrderNumber = "c4a82927-67ac-4aa1-a045-902caf095900",
                            OrderStatus = 0,
                            ShippingDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7213),
                            UserFullName = "User 1",
                            UserId = 3
                        },
                        new
                        {
                            ...
                            BookId = 1,
                            Digital = true,
                            OrderDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7215),
                            OrderNumber = "5ed359e2-1ed1-4bea-bdcf-018afff2f05f",
                            OrderStatus = 0,
                            ShippingDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7217),
                            UserFullName = "User 2",
                            UserId = 4
                        },
                        new
                        {
                            ...
                            BookId = 3,
                            Digital = true,
                            OrderDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7219),
                            OrderNumber = "7bc51742-86ee-4611-a46d-0dcc6f0161b6",
                            OrderStatus = 0,
                            ShippingDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7220),
                            UserFullName = "User 2",
                            UserId = 4
                        },
                        new
                        {
                            ...
                            BookId = 3,
                            Digital = false,
                            OrderDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7223),
                            OrderNumber = "f5a98595-55d5-41f0-a467-d71ad7ba0603",
                            OrderStatus = 0,
                            ShippingDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7224),
                            UserFullName = "User 2",
                            UserId = 4
                        });
                });

            modelBuilder.Entity("knowledge_hub.WebAPI.Database.OrderAddress", b =>
                {
                    b.Property<int>("OrderAddressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderAddressId"), 1L, 1);
            ...
            modelBuilder.Entity("knowledge_hub.WebAPI.Database.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookId = 1,
                            Comment = "Great!",
                            PostDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7261),
                            Score = 5.0,
                            UserId = 3
                        },
                        new
                        {
                            ...
                            BookId = 1,
                            Comment = "Great!",
                            PostDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7263),
                            Score = 4.0,
                            UserId = 4
                        },
                        new
                        {
                            ...
                            BookId = 3,
                            Comment = "Great!",
                            PostDate = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7266),
                            Score = 4.0,
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("knowledge_hub.WebAPI.Database.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TransactionTime = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7238)
                        },
                        new
                        {
                            TransactionId = 2,
                            ...
                            OrderId = 2,
                            Price = 12.99,
                            TransactionTime = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7241)
                        },
                        new
                        {
                            TransactionId = 3,
                            ...
                            OrderId = 3,
                            Price = 13.99,
                            TransactionTime = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7243)
                        },
                        new
                        {
                            TransactionId = 4,
                            ...
                            TransactionTime = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7245)
                        },
                        new
                        {
                            TransactionId = 5,
                            ...
                            TransactionTime = new DateTime(2022, 9, 12, 20, 30, 24, 788, DateTimeKind.Local).AddTicks(7247)
                        });
                });
