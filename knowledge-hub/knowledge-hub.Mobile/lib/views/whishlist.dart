...
class WhishlistState extends State<WishlistWidget> {
  ...
  fetchWishlistBooks() async {
    final response = await http.get(
        Uri.parse(
            '${PersistentDataService.instance.BackendUri}/api/Wishlist/WishlistByUserId?userId=${AccountService.instance.userData.UserId.toString()}'),
    ...
    return loaded
        ...
        : Center(
            child: Column(
              ...
              children: const [Text("No books in wishlist...")],
            ),
          );
  }
}
