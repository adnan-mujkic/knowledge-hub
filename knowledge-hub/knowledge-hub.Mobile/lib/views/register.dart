...
class RegisterWidget extends StatefulWidget {
  ...
  var userRegistration = UserRegistrationRequest(
      Username: "",
      Biography: "",
      LoginId: 0);
...
class RegisterState extends State<RegisterWidget> {
  ...
  createAccount() async{
    ...
    if(response.statusCode == 200){
      widget.createAccountEvent.broadcast(Values<String, String>(widget.userRegister.Email!, widget.userRegister.Password!));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          loginOrUserRegistration? Center(
                                ...
                                child: SizedBox(
                                    child: Padding(
                                      ...
                                      child: TextField(
                                        decoration: InputDecoration(
                                            border: InputBorder.none,
                                            hintText: this.widget.userRegistration.Username),
                                        style: const TextStyle(fontSize: 12),
                                        onChanged: (String value){
                                          this.widget.userRegistration.Username = value;
                                        },
                                      ),
                                    )),
                              ),
                                ...
                                child: SizedBox(
                                    child: Padding(
                                      ...
                                      child: TextField(
                                        decoration: InputDecoration(
                                            border: InputBorder.none,
                                            hintText: this.widget.userRegistration.Biography),
                                        style: const TextStyle(fontSize: 12),
                                        onChanged: (String value){
                                          this.widget.userRegistration.Biography= value;
                                        },
                                      ),
                                    )),
                              ),
